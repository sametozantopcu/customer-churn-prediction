...
- Logistic Regression modeli: %{val_acc*100:.1f} doğruluk (accuracy)
- KNN (k=5) modeli: %{accuracy*100:.1f} doğruluk (accuracy)
...
Validasyon aşamasında Lojistik Regresyon (%{val_acc*100:.1f}) KNN'den (%{accuracy*100:.1f}) daha başarılı 
